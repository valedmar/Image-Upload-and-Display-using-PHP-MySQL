...
<body>
  ...
  <div class="container">
    ...
    <div class="container my-5">
      <h1 class="text-center">Upload jeres billeder!</h1>
    </div>
    ...
    <div class="container my-5 w-75">
      ...
      <form action="handleInput.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          <label for="photo" class="form-label">Billeder*</label>
          ...
          <input type="file" class="form-control" multiple="multiple" id="photo" name="photo[]" accept="image/*">
        </div>
